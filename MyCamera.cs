...
namespace CotofrecMaria3131B
{
    class MyCamera
    {
        ...
        private Vector3 eyeFar = new Vector3(50, 20, 100);
        private Vector3 eyeClose = new Vector3(12, 20, 20);
        ...
        public MyCamera()
        {
            eye = new Vector3(12, 20, 40);
            target = new Vector3(0, 0, 0);
            up_vector = new Vector3(0, 1, 0);
        }

        public MyCamera(int _eyeX, int _eyeY, int _eyeZ, int _targetX, int _targetY, int _targetZ, int _upX, int _upY, int _upZ)
        {
        ...
        public MyCamera(Vector3 _eye, Vector3 _target, Vector3 _up)
        {
            eye = _eye;
            target = _target;
            up_vector = _up;
